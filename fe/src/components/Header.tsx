...
export default function Header({ onClickProfile = () => {} }: Props) {
  ...
  return (
    <header className="flex h-16 flex-row items-center gap-4 bg-zinc-800 px-4">
      ...
      <div className="flex h-full items-center border-l border-emerald-400 bg-zinc-700 font-bold transition-transform duration-200 hover:translate-y-2 hover:scale-105 md:min-w-64">
        {user ? (
          <div
